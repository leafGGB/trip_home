<template>
    <div class="comment">
        <detal-section title="热门评论" more-text="查看全部37条评论">
            <div class="comment-inner">
                ...
                <div class="tags">
                    <template v-for="(item, index) in comment.commentTagVo" :key="index">
                        <span class="item" :style="{ color: item.color, background: item.backgroundColor }">{{ item.text
                        }}</span>
                    </template>
                </div>
                <div class="content">
                    <div class="user">
                        ...
                        <div class="profile">
                            ...
                            <div class="data">{{ comment.comment.checkInDate }}</div>
                        </div>
                    </div>
                    <div class="text">
...
<script setup>
import DetalSection from '@/components/detal-section/detal-section.vue';
