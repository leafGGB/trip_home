<template>
    <div class="detail top-page" ref="detailRef">
        <tab-control v-if="showTabControl" class="tabs" @tabItemClick="tabClick" :titles="names" ref="tabControlRef" />
        ...
        <div class="main" v-if="mainPart" v-memo="[mainPart]">
            ...
            <detail-notice name="须知" :ref="getSectionRef" :orderRules="mainPart.dynamicModule.rulesModule.orderRules" />
...
import DetailAction from './cpns/detail_09-action-bar.vue';
